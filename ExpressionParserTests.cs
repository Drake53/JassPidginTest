...
namespace War3Net.CodeAnalysis.Jass.Tests
{
    ...
    public class ExpressionParserTests
    {
        ...
        public void TestExpressionParser(string expression, IExpressionSyntax? expected = null)
        {
            if (expected is null)
            {
                SyntaxAssert.ExpressionThrowsException(expression, false);
            }
            else
            {
        ...
        {
            // These tests fail when not using token parser:
            ...
            yield return new object?[] { @"function foo™" };
            #endregion
            ...
            yield return new object?[] { "'\0\0\0\0'", new JassFourCCLiteralExpressionSyntax(0) };
            ...
            yield return new object?[] { "\"  \\\"  \"", new JassStringLiteralExpressionSyntax("  \\\"  ") };
            #endregion
