...
namespace War3Net.CodeAnalysis.Jass
{
    ...
    {
        private static Parser<char, JassIdentifierNameSyntax> GetIdentifierNameParser()
        {
#if false
        ...
        {
            return Char('\\').Then(EscapeChar).Or(AnyCharExcept('"').Map(@char => @char.ToString())).ManyString().Between(Char('"'))
